...
-- Idempotent : yes — CREATE TABLE IF NOT EXISTS, CREATE POLICY IF NOT EXISTS
-- ============================================================
...
CREATE POLICY IF NOT EXISTS "completions_select_own"
...
CREATE POLICY IF NOT EXISTS "completions_service_insert"
